...
struct StoryLibrary {
  static let characters: [LifeStage: StoryCharacter] = [
    .prePuberty: StoryCharacter(name: "Mira", age: 9, stageName: "Pre-Puberty", avatarIcon: "person.crop.circle", accentColor: .lumaPinkLight),
    .puberty: StoryCharacter(name: "Priya", age: 13, stageName: "Puberty", avatarIcon: "person.crop.circle", accentColor: .lumaPinkBubble),
    .reproductive: StoryCharacter(name: "Ananya", age: 25, stageName: "Reproductive", avatarIcon: "person.crop.circle", accentColor: .lumaAccent),
    .perimenopause: StoryCharacter(name: "Sunita", age: 46, stageName: "Perimenopause", avatarIcon: "person.crop.circle", accentColor: .orange),
    .menopause: StoryCharacter(name: "Rekha", age: 52, stageName: "Menopause", avatarIcon: "person.crop.circle", accentColor: .purple),
    .postMenopause: StoryCharacter(name: "Lakshmi", age: 60, stageName: "Post-Menopause", avatarIcon: "person.crop.circle", accentColor: .teal)
  ]
